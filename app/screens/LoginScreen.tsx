...
const LoginScreen = () => {
    ...
    const handleLogin = async () => {
        ...
        if (!/\S+@\S+\.\S+/.test(formData.email)) newErrors.email = 'El formato del correo no es válido';
    ...
    return (
        <ScrollView contentContainerStyle={styles.container}>
            ...
            <View style={styles.formSection}>
                ...
                <TouchableOpacity
                    style={[styles.loginButton, (isFormEmpty || isLoading) && styles.loginButtonDisabled]}
                    onPress={handleLogin}
                    disabled={isFormEmpty || isLoading}
                >
                    <Text style={[styles.loginButtonText, isFormEmpty && styles.loginButtonTextDisabled]}>
                        INICIAR SESIÓN
                    </Text>
                </TouchableOpacity>
                ...
                <View style={styles.bottomSection}>
                    ...
                    >
                        <Text style={styles.createAccountButtonText}>Crear una cuenta ahora</Text>
                    </TouchableOpacity>
                </View>
            </View>
        </ScrollView>
